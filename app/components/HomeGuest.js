...
function HomeGuest() {
  ...
  useEffect(() => {
    if (state.password.value) {
      const delay = setTimeout(() => dispatch({ type: "passowrdAfterDelay" }), 800)
      return () => clearTimeout(delay)
    }
    ...
    <Page title="Welcome" wide={true}>
      <div className="row align-items-center">
        <div className="col-lg-7 py-3 py-md-5">
          <h1 className="display-3">Heyy! Welcome Home</h1>
          <p className="lead text-muted">Are you sick of short tweets and impersonal &ldquo;shared&rdquo; posts that are reminiscent of the late 90&rsquo;s email forwards? We believe getting back to actually writing is the key to enjoying the internet again. Come on!! Here you go!!</p>
        </div>
        <div className="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <CSSTransition in={state.username.hasErrors} timeout={300} classNames="liveValidateMesage" unmountOnExit>
            ...
            <div className="form-group">
              ...
              <CSSTransition in={state.email.hasErrors} timeout={300} classNames="liveValidateMesage" unmountOnExit>
            ...
            <div className="form-group">
              ...
              <CSSTransition in={state.password.hasErrors} timeout={300} classNames="liveValidateMesage" unmountOnExit>
